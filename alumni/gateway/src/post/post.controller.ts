...
export class PostController {
  ...
  @UseGuards(AuthGuard)
  @Get('user/allPosts/:internId')
  findPostsByAuthor(@Param('internId') internId: string, @Req() req:Request,  @Res() res: Response) {
    const userId = internId != 'undefined' ? internId : req['user'].infoU.id
